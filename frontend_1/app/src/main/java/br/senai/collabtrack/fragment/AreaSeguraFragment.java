...
import br.senai.collabtrack.adapter.AreaSeguraMonitoradoAdapter;
...
import br.senai.collabtrack.domain.to.AreaSeguraTO;
...
public class AreaSeguraFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup viewGroup, @Nullable Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null && imageViewCorSelecionada == 0 && imageViewCorBordaSelecionada == 0){
            ...
            imageViewCorBordaSelecionada = CollabtrackApplication.COLOR_PICKER_DEFAULT_BORDER_COLOR;
    ...
    private class SalvarAreaSegura extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpUtil.post(JsonUtil.toJson(new AreaSeguraTO(areaSegura, monitor, areaSeguraMonitorados)), CollabtrackApplication.API_PATH_AREA_SEGURA, new HttpCallback() {
                @Override
    ...
    private class EditarAreaSegura extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpUtil.put(JsonUtil.toJson(new AreaSeguraTO(areaSegura, monitor, areaSeguraMonitorados)), CollabtrackApplication.API_PATH_AREA_SEGURA, new HttpCallback() {
                @Override
                public void onSuccess(String response) {
                    areaSeguraTO = (AreaSeguraTO) JsonUtil.toObject(response, AreaSeguraTO.class);
                    editarAreaSegura();
