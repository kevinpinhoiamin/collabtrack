...
import br.senai.collabtrack.fragment.dialog.FiltrarLocalizacoesDialogFragment;
import br.senai.collabtrack.request.BuscarLocalizacaoRequest;
...
import br.senai.collabtrack.service.mapa.MapMonitorado;
...
import br.senai.collabtrack.util.Permission;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nav_item_filtrar:
                ...
                fragment.show(getFragmentManager(), CollabtrackApplication.DEBUG_TAG);
        ...
        new BuscarLocalizacaoRequest(monitorados, periodo, pontos, new HttpCallback() {
            ...
            public void onSuccess(String response) {
                ...
                if ((localizacaoList1 != null && localizacaoList1.size() > 0) || (localizacaoList2 != null && localizacaoList2.size() > 0)) {
                    ...
                    Toast.makeText(CollabtrackApplication.getContext(), getString(R.string.nenhuma_localizaca_encontrada), Toast.LENGTH_LONG).show();
                }
