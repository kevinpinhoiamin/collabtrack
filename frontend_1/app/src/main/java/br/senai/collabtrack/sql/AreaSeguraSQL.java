...
public class AreaSeguraSQL extends BaseSQL implements AreaSeguraDAO {
    ...
    public List<AreaSegura> findAll() {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("area_segura", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, null, null, null, null, "nome COLLATE NOCASE ASC", null);
            return parseList(c);
        }finally {
            db.close();
        }
    ...
    public AreaSegura find(Long id) {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("area_segura", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, "id=?", new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    public List<AreaSegura> parseList(Cursor cursor) {
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                areaSegura.setRowid(cursor.getLong(CollabtrackApplication.SQL_ROW_ID_INDEX));
