...
public class MonitoradoSQL extends BaseSQL implements MonitoradoDAO{
    ...
    public List<Monitorado> findAll() {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("monitorado", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, null, null, null, null, null, null);
            return parseList(c);
        }finally {
            db.close();
        }
    ...
    public Monitorado find(Long id) {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("monitorado", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, "id=?", new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    public List<Monitorado> parseList(Cursor cursor) {
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                monitorado.setRowid(CollabtrackApplication.SQL_ROW_ID_INDEX);
