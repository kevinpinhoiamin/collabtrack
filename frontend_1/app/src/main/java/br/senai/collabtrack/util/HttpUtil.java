...
import br.senai.collabtrack.CollabtrackSingleton;
import br.senai.collabtrack.R;
import br.senai.collabtrack.exception.ErrorResponseEntity;
...
public class HttpUtil {
    ...
    public static String getBasicAuthenticationHash(){
        String credentials = CollabtrackApplication.API_USER+":"+ CollabtrackApplication.API_PASSWORD;
    ...
    public static void getImage(String url, ImageView view, Callback callback, boolean cache){
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder()
                .authenticator(new Authenticator()
                {
                    ...
                    {
                        //String credential = Credentials.basic(CollabtrackApplication.API_USER, CollabtrackApplication.API_PASSWORD);
        ...
        Picasso.Builder builder = new Picasso.Builder(CollabtrackApplication.getContext())
    ...
    private static void defaultError(VolleyError error){
        ...
        if (error.networkResponse instanceof NetworkResponse && error.networkResponse.data != null && error.networkResponse.statusCode == BAD_REQUEST) {
            ...
            message = CollabtrackApplication.getContext().getString(R.string.voce_nao_esta_conectado);
        ...
        if(message != null){
            Toast.makeText(CollabtrackApplication.getContext(), message, Toast.LENGTH_LONG).show();
        }

        Log.e(CollabtrackApplication.DEBUG_TAG, String.valueOf(error));
        Log.e(CollabtrackApplication.DEBUG_TAG, message);
