...
import br.senai.collabtrack.dao.AreaSeguraMonitoradoDAO;
...
public class AreaSeguraMonitoradoSQL extends BaseSQL implements AreaSeguraMonitoradoDAO {
    ...
    public List<AreaSeguraMonitorado> findAll() {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("area_segura_has_monitorado", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, null, null, null, null, null, null);
            return parseList(c);
        }finally {
            db.close();
        }
    ...
    public AreaSeguraMonitorado find(Long idAreaSegura, Long idMonitorado) {
        ...
        try{
            String[] where = new String[]{String.valueOf(idAreaSegura), String.valueOf(idMonitorado)};
            Cursor c = db.query("area_segura_has_monitorado", new String[] { CollabtrackApplication.SQL_ROW_ID_COLUMN, "*" }, "id_area_segura=? AND id_monitorado=?", where, null, null, null, null);
