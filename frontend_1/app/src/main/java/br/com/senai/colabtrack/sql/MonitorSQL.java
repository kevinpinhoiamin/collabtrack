...
public class MonitorSQL extends BaseSQL implements MonitorDAO {
    ...
    public Long save(Monitor o) {
        ...
        context.deleteDatabase(ColabTrackApplication.DATABASE);
    ...
    public List<Monitor> findAll() {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("monitor", new String[] { ColabTrackApplication.SQL_ROW_ID_COLUMN, "*" }, null, null, null, null, null, null);
            return parseList(c);
        }finally {
            db.close();
        }
    ...
    public Monitor find(Long id) {
        SQLiteDatabase db = getWritableDatabase();
        try{
            Cursor c = db.query("monitor", new String[] { ColabTrackApplication.SQL_ROW_ID_COLUMN, "*" }, "id=?", new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    public List<Monitor> parseList(Cursor cursor) {
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                monitor.setRowid(cursor.getLong(ColabTrackApplication.SQL_ROW_ID_INDEX));
