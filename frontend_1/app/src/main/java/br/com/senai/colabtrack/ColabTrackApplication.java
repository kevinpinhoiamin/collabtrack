...
public class ColabTrackApplication extends Application{

    private static ColabTrackApplication instance;

    public static final boolean MONITORAR = false;
    ...
    public static final String DATABASE = "colabtrack.sqlite";
    ...
    // Broadcast Receiver
    public static final String LOCALIZACAO_BROADCAST_RECEIVER = "br.com.senai.colabtrack.fragment.GoogleMapFragment";
    public static final String STATUS_BROADCAST_RECEIVER = "br.com.senai.colabtrack.fragment.MonitoradoStatusFragment";
    public static final String MONITORADO_TO_BROADCAST_RECEIVER = "br.com.senai.colabtrack.domain.to.MonitoradoTO";
    ...
    public static ColabTrackApplication getInstance(){
        return instance;
    }
