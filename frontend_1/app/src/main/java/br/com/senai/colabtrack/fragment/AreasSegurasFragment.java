...
import br.com.senai.colabtrack.adapter.AreaSeguraAdapter;
...
import br.com.senai.colabtrack.fragment.dialog.AreaSeguraDialogFragment;
...
public class AreasSegurasFragment extends BaseFragment implements AreasSegurasActivity.OnBackPressedListener{
    ...
    private class ExcluirAreaSegura extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpUtil.delete(ColabTrackApplication.API_PATH_AREA_SEGURA+"?id="+areaSegura.getId()+"&celular="+monitor.getCelular(), new HttpCallback() {
                @Override
    ...
    private class AlterarStatus extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            ...
            HttpUtil.put(JsonUtil.toJson(this.areaSeguraMonitorado), ColabTrackApplication.API_PATH_AREA_SEGURA_MONITORADO, new HttpCallback() {
                @Override
                public void onSuccess(String response) {
                    alterarStatus();
                }
    ...
    private class StartDialog extends AsyncTask<Void, Void, Void>{
        ...
        private void startDialog(){
            ...
            areaSeguraDialogFragment.show(getFragmentManager(), ColabTrackApplication.DEBUG_TAG);
    ...
    private void startDialogConfirmacao(AreaSegura areaSegura){
        ...
        areaSeguraExcluirFragment.show(getFragmentManager(), ColabTrackApplication.DEBUG_TAG);
